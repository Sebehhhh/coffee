                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Tambah Banner</h4>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="judul" class="form-control" name="judul" placeholder="Judul Banner" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="sub_judul">Sub Judul</label>
                                                <input type="text" id="sub_judul" class="form-control" name="sub_judul" placeholder="Sub Judul Banner" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
