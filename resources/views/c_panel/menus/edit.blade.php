                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nama" class="form-control @error('nama') is-invalid @enderror" 
                                                    name="nama" value="{{ old('nama', $menu->nama) }}" placeholder="Nama Menu">
                                                @error('nama')
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="harga" class="form-control @error('harga') is-invalid @enderror" 
                                                    name="harga" value="{{ old('harga', $menu->harga) }}" placeholder="Harga Menu">
                                                @error('harga')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('best_seller') is-invalid @enderror" 
                                                    ...
                                                    <option value="0" {{ old('best_seller', $menu->best_seller) == '0' ? 'selected' : '' }}>Tidak</option>
                                                    <option value="1" {{ old('best_seller', $menu->best_seller) == '1' ? 'selected' : '' }}>Ya</option>
                                                </select>
                                                @error('best_seller')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('sampel') is-invalid @enderror" 
                                                    ...
                                                    <option value="0" {{ old('sampel', $menu->sampel) == '0' ? 'selected' : '' }}>Tidak</option>
                                                    <option value="1" {{ old('sampel', $menu->sampel) == '1' ? 'selected' : '' }}>Ya</option>
                                                </select>
                                                @error('sampel')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
